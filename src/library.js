...
function redrawButtonText(){
    buttonAddWatch.textContent = movieLocalStorage.watchedExists(selectedMovieIndex) ? "remove from watched" : "add to watched";    
    buttonAddQueue.textContent = movieLocalStorage.queueExists(selectedMovieIndex) ? "remove from queue" : "add to queue";
}
